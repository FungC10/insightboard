      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">InsightBoard</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              A modern crypto market dashboard providing real-time data, interactive charts,
              and comprehensive market insights for traders and investors.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <p className="text-center text-gray-400 text-sm">
            © 2024 InsightBoard. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
